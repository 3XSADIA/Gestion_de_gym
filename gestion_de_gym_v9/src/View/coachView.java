...
public class coachView extends JFrame implements ActionListener, KeyListener {
	...
	public coachView() {
		...
		btnAdd.setBounds(175, 380, 114, 45);
		panel_1.add(btnAdd);
		...
		btnUpdate.setBounds(445, 380, 114, 45);
		...
		btnExit.setBounds(583, 380, 114, 45);
		panel_1.add(btnExit);

		JLabel lblNewLabel_6 = new JLabel("");
		lblNewLabel_6.setIcon(new ImageIcon(coachView.class.getResource("/img/icons8-chercher-26.png")));
		...
		Statistiques_1_1_1.setForeground(new Color(113, 106, 111));
		...
		panel_4_1.setForeground(new Color(113, 106, 111));
		...
		lblGestionPaiement.setForeground(new Color(113, 106, 111));
		...
		lblGestionCoach.setForeground(new Color(113, 106, 111));
		...
		panel_4.setForeground(new Color(113, 106, 111));
		...
		Statistiques_1.setForeground(new Color(113, 106, 111));
		Statistiques_1.setFont(new Font("Californian FB", Font.BOLD | Font.ITALIC, 22));
		...
		Statistiques.setForeground(new Color(113, 106, 111));
