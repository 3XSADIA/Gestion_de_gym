...
public class seanceView extends JFrame implements ActionListener, KeyListener {
	...
	private JTextField Instructeur_tf;
	private JTextField Horaire_tf;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					seanceView frame = new seanceView();
	...
	public seanceView() {
		...
		Instructeur_tf = new JTextField();
		Instructeur_tf.setFont(new Font("Californian FB", Font.PLAIN, 17));
		Instructeur_tf.setBounds(188, 160, 138, 24);
		panel_3.add(Instructeur_tf);
		Instructeur_tf.setColumns(10);
		...
		table.setModel(
				new DefaultTableModel(new Object[][] {}, new String[] { "Id", "Label", "Instructeur", "Horaire" }));
