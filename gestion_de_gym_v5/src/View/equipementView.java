...
public class equipementView extends JFrame implements ActionListener, KeyListener {
	...
	private JTextField Quantite_tf;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					equipementView frame = new equipementView();
	...
	public equipementView() {
		...
		btnAdd.setSelectedIcon(new ImageIcon(equipementView.class.getResource("/img/img2.png")));
		...
		table.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "Id", "Nom", "Quantite" }));

		JLabel lblNewLabel_6 = new JLabel("");
		lblNewLabel_6.setIcon(new ImageIcon(equipementView.class.getResource("/img/search-24.png")));
		lblNewLabel_6.setBounds(329, 11, 30, 43);
		...
		lblNewLabel_1_1.setIcon(new ImageIcon(equipementView.class.getResource("/img/icons8-gym-64.png")));
