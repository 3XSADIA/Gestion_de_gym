...
public class courView extends JFrame implements ActionListener, KeyListener {

	private static final long serialVersionUID = 1L;
	private static final AbstractButton Horaire_tf = null;
	...
	public courView() {
		...
		btnAdd.setSelectedIcon(new ImageIcon(courView.class.getResource("/img/img2.png")));
		btnAdd.setBounds(175, 380, 115, 45);
		panel_1.add(btnAdd);

		search_tf = new SearchTextField("entrer le label de cours");
		...
		lblNewLabel_2_1.setBounds(21, 142, 74, 24);
		panel_3.add(lblNewLabel_2_1);
		lblNewLabel_2_1.setFont(new Font("Californian FB", Font.PLAIN, 20));

		JLabel lblNewLabel_2 = new JLabel("Id");
		lblNewLabel_2.setBounds(21, 46, 17, 24);
		...
		lblNewLabel_2_4_1.setBounds(21, 235, 138, 31);
		panel_3.add(lblNewLabel_2_4_1);

		JButton showEquipmentsButton = new JButton("Afficher les \u00E9quipements");
		showEquipmentsButton.setBackground(new Color(255, 255, 255));
		showEquipmentsButton.setFont(new Font("Californian FB", Font.BOLD | Font.ITALIC, 12));
		showEquipmentsButton.setForeground(new Color(113, 113, 113));
		showEquipmentsButton.setBounds(188, 240, 138, 26);
		panel_3.add(showEquipmentsButton);
		JPopupMenu popupMenu = new JPopupMenu();
		DefaultListModel<String> equipmentListModel = new DefaultListModel<>();
		equipmentList = new JList<>(equipmentListModel);
		JScrollPane scrollPanee = new JScrollPane(equipmentList);
		popupMenu.add(scrollPanee);

		// Ajouter un écouteur de clic au bouton pour afficher le menu contextuel
		showEquipmentsButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				popupMenu.show(showEquipmentsButton, 0, showEquipmentsButton.getHeight());
			}
		});
		...
		lblNewLabel_4.setIcon(new ImageIcon(courView.class.getResource("/img/search-16.gif")));
		lblNewLabel_4.setBounds(228, 11, 30, 43);
		panel_1.add(lblNewLabel_4);

		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon(courView.class.getResource("/img/search-16.gif")));
		...
		lblNewLabel_6.setIcon(new ImageIcon(courView.class.getResource("/img/icons8-chercher-26.png")));
		...
		lblNewLabel_1_1.setIcon(new ImageIcon(courView.class.getResource("/img/mm (3).png")));
		...
		panel_4_1_1_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				equipementView view = null;
				try {
					view = new equipementView();
