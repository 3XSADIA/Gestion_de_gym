...
public class clientView extends JFrame implements ActionListener, KeyListener {
	...
	public clientView() throws SQLException {
		...
		search_tf = new SearchTextField("entrer le nom de Client" + "");
		...
		NumTelephone.setBounds(22, 194, 138, 31);
		...
		showCoursButton.setBounds(188, 240, 138, 26);
		...
		table.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				if (!e.getValueIsAdjusting() && table.getSelectedRow() != -1) {
					...
					String dateString = model.getValueAt(selectedRowIndex, 3).toString();
					SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
					Date dateInscr = null;
					try {
						dateInscr = dateFormat.parse(dateString);
					} catch (ParseException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
					dateChooser.setDate(dateInscr);
					String tele = model.getValueAt(selectedRowIndex, 4).toString();
