...
public class ClientController {
	...
	public static void table_load() throws SQLException {
		...
		clientView.coursList.setModel(coursListModel);
	...
	public class AddButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			Object[] coursArray = clientview.coursList.getSelectedValues();
			String cours = Arrays.stream(coursArray).map(Object::toString).collect(Collectors.joining(", "));
			try {
				ClientModel.createClient(nom, prenom, tele, DI, cours);
				table_load();
	...
	private class UpdateButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			String cours = Arrays.stream(coursArray).map(Object::toString).collect(Collectors.joining(", "));
			try {
				ClientModel.updateClient(search_nom, nom, prenom, tele, DI, cours);
				table_load();
