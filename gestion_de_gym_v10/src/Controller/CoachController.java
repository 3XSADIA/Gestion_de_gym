...
public class CoachController {
	...
	public class AddButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			String mission = coachview.Mission_tf.getText();
			String salaire = coachview.Salaire_tf.getText();

			try {
				coachmodel.createCoach(nom, prenom, tele, mission, salaire);
				table_load();
	...
	private class UpdateButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				coachmodel.updateCoach(search_nom, nom, prenom, tele, mission, salaire);
				table_load();
		...
		public void keyReleased(KeyEvent e) {
			try {
				...
				if (rs.next() == true) {
					...
					coachview.Mission_tf.setText(mission);
				} else {
